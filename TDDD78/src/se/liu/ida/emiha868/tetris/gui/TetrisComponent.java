...
/**
 * Tetriscomponent is a boardlistener that listens to the board it has as input
 * it is responsible of painting the board every time it has changed. This is done by letting
 * the board notify it. This way following the Observer pattern design.
 *
 * Also responsible for the binding of keybindings to certain keys that control movement
 * of a a falling poly.
 */



/* Magic numbers are trivial, ignore*/
public class TetrisComponent extends JComponent implements BoardListener
{
    /**
     * This is a constant that determines the length of a brick on the board.
     * Together with the size of the board it determines the size of the frame.
     */
    public static final int SQUARE_LENGTH = 50;
    private final static int MARGIN = 2;
    /**
     * This is the board that was given as input which the component listens to
     */
    public Board board;
    ...
    /*BoardhChanged is the method that calls paintcomponent*/
    @Override
...
//Keybindings are being bound below
